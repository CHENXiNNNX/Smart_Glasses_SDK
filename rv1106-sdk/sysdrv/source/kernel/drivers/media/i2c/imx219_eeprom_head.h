...
#ifndef IMX219_EEPROM_HEAD_H
#define IMX219_EEPROM_HEAD_H
...
/* imx219_eeprom device structure */
struct imx219_eeprom_device {
	struct v4l2_subdev sd;
	struct i2c_client *client;
	struct imx219_otp_info *otp;
};

#endif /* IMX219_EEPROM_HEAD_H */
